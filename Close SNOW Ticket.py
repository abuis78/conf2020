...
def SNOW_Update_Resolved(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    template = """{{\"resolution_code\":\"Solved Remotely (Workaround)\",\"state\":\"6\",\"caller_id\":\"phantom\",\"resolution_notes\":\"Phantom: resolved via API\", \"work_notes\": \"Service was started and ITSI episode status is been set to resolved\"}}"""
